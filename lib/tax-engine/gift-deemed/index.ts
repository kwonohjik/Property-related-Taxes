/** 증여로 보는 경우 — barrel (Phase 1~2) */
export * from "./types";
export { calcDeemedGift } from "./router";
export { calcInsuranceGift } from "./insurance";
export { calcBargainTransferGift } from "./bargain-transfer";
export { calcDebtForgivenessGift } from "./debt-forgiveness";
export { calcFreeRealEstateGift } from "./free-realestate-use";
