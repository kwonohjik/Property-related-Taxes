...
//    ⚠️ **다만 pre-deemed에서 실무는 「의제취득일 현재」로 취급한 사례가 일관된다**
//       (국심2003부0627 판단부가 조문에 없는 괄호를 삽입 · 국심2002중1431 · 조심2010서1195).
//       셋 다 **토지**(§164④·§163⑨ 본문) 사안이고 시점 자체는 쟁점이 아니었다.
//       현재 ②는 **주택 §164⑦ · 상가 §164⑥**(§163⑨2호)뿐이라 직접 대상이 아니지만,
//       **토지 §164④를 구현할 때 반드시 선결**할 것(계획서 V-2와 함께).
