...
/**
 * 해외주식 양도소득세 계산 (§94①3호다목 · §118②이 준용하는 §118의2~§118의4·§118의6)
 *
...
export function calculateForeignStockTax(input: ForeignStockInput): ForeignStockResult {
  ...
  //
  // 🔑 국외주식 양도도 **같은 양도소득세 신고**다 — 다만 근거는 **§118의8이 아니다**.
  //    §118의2의 「국외자산」에서 **3호·4호가 삭제**돼 국외주식(§94①3호다목)은 §118의8의
  //    적용대상이 아니다. 국외주식 양도소득은 그냥 §94① 양도소득이라 **§110①(확정신고)이
  //    직접** 걸리고, 가산세는 국세기본법 §47조의2~§47조의4가 「과세표준신고」 단위로 직접
  //    걸린다. §118②은 「양도소득세**액의 계산**」만 대체할 뿐 신고·납부 축은 건드리지 않는다.
  //    ⚠️ §105①은 본문 괄호에서 **다목을 제외**한다 ⇒ 국외주식에 **예정신고 의무는 없다**.
  //    종전에는 신고축이 타입에 없어 국외 신고의 가산세가 통째로 빠져 있었다.
  //
