 ...
 *   취득시 기준시가 = 취득일 이전 1개월 종가평균 (모법 §99①3, 시행령 §165③ 준용)
 *   양도시 기준시가 = 양도일 이전 1개월 종가평균 (모법 §99①3, 시행령 §165③ 준용)
 *
      ...
      warnings: [
        shareCount <= 0
          ...
          : transferStd <= 0
            ...
            : "취득일 이전 1개월 종가평균이 0 이하 — 상장 환산취득가·개산공제가 0으로 산출됩니다 (시행령 §176의2②1호 환산비율 분자)",
      ],
    };
  }
