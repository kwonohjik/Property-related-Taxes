 ...
 *
 * 출처: 교재 PDF "연부연납가산금의 가산율 고시 연혁" + 기획재정부 고시.
 * ⚠️ 시행일 경계는 국기칙 §19의3 개정 이력으로 재확인 후 동결할 것(현재 교재 기준).
 *
...
export const INSTALLMENT_SURCHARGE_RATE_HISTORY: readonly SurchargeRatePeriod[] = [
  ...
  { from: "2015-03-06", rate: 0.025 }, // 연 25/1,000
  { from: "2016-03-06", rate: 0.018 }, // 연 1.8%
