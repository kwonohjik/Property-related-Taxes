...
export const REGULATED_REGIONS: RegulatedRegion[] = [
  ...
  //
  //   ⚠️ **부분 이행이다.** 구 3건 중 `41590420 동탄면`은 현행 대응을 확정하지 못했다 —
  //   동탄면은 이미 폐지돼 현행 어느 구에도 없고, 그 영역이 지금 어느 법정동들인지는
  //   2017년 시점 법정동 대장이 있어야 알 수 있다. 국토부 실거래가(RTMS) 실측으로는
  //   2013·2015·2016·2017년 41597 관내에 이미 「동탄면」이 아니라 동(洞)만 나타나,
  //   종전 데이터의 `41590420` 자체가 지정 당시에도 낡았을 가능성이 있다.
  //   확정 전까지 **넓히지 않는다**(미적용 = 납세자 유리 방향). → 계획서 Y-13.
  { code: "41597", name: "경기도 화성시 동탄구",
    designations: [
      // 과거 이력 — 동탄2 지구 한정(구 41590127·41590128에 대응)
    ...
    includedSubCodes: [
      { codePrefix: "41597102", name: "동탄2 반송동", appliesFrom: "2017-08-03", appliesTo: "2022-11-13" },
      { codePrefix: "41597103", name: "동탄2 석우동", appliesFrom: "2017-08-03", appliesTo: "2022-11-13" },
    ] },
