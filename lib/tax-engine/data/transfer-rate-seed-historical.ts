/**
 * transfer-rate-seed-historical.ts — 양도소득세 역사 세율 시드 데이터 (2023 이전, 단일 소스)
 *
 * 목적: 2023년 이전 양도일 세율 매칭. loadFallbackTransferRates(targetDate)·시딩 공용.
 *   effective_date <= targetDate 중 최신 row 선택 → 현행(2023-01-01) + 역사 병합 필요.
 *
