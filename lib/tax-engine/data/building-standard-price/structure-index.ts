 ...
 *   · 2013년 4행: ✅ **해소(2026-08-27 고시 원문 실측)** — 국세청고시 제2013-2호 제7조는
 *     4행(100)에 [철근콘크리트조·석조·PC조·목조·라멘조·ALC조], 5행(90)에 [연와조·시멘트벽돌조·
 *     황토조·철골조·**스틸하우스조**·보강콘크리트조·시멘트블록조·보강블록조·와이어패널조]를 둔다.
 *     ⇒ **석조만 4행이고 스틸하우스조는 5행(90)** 이다. 종전 주석의 「스틸하우스조도 4행(100)」은
 *     사실과 다르며 데이터(90)가 옳았다. 「인접연도 정합」 논거도 석조에만 성립한다 —
 *     스틸하우스조는 2014년 고시가 4행에 **굵게 추가**해 2013=90 → 2014=100 으로 이동한 것이
 *     원문으로 확인된다(고정: gazette-era-b-membership.anchor.test.ts).
 */
