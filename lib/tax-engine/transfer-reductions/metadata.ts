...
export const REDUCTION_METADATA: Record<TransferReductionId, ReductionMetadata> = {
  ...
  public_expropriation: {
    ...
    effectLabel: "현금 15% / 채권 20~45% (2025+ 개정 · 연간 한도 2억)",
    isFullyImplemented: true,
  },
  gb_designated_land: {
    id: "gb_designated_land",
    article: TRANSFER_REDUCTION_ARTICLE.GB_DESIGNATED_LAND,
    category: "standalone",
    effectCategory: "tax_amount",
    uiLabel: "§77의3 — 개발제한구역 매수 토지 감면",
    effectLabel: "40%(지정일 前 취득+거주) / 25%(20년 前 취득+거주) · 연간 한도 2억",
    isFullyImplemented: true,
  },
  replacement_land_comp: {
    id: "replacement_land_comp",
    article: TRANSFER_REDUCTION_ARTICLE.REPLACEMENT_LAND,
    category: "standalone",
    effectCategory: "tax_amount",
    uiLabel: "§77의2 — 대토보상 과세특례",
    effectLabel: "대토보상분 40% 세액감면 · 연간 한도 2억 (과세이연 별도)",
    isFullyImplemented: true,
  },
};
