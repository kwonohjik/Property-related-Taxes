...
export const TRANSFER_DECREE_ADDITIONS: VerificationRule[] = [
  ...
  {
    /**
     * §155의2 — 장기저당담보주택(역모기지). P3에서 인용 신설.
     * 키워드는 DRF 실독 원문 verbatim(MST 286211). ①1호의 「60세」는 요건값이라 동결한다 —
     * 2025-12-30 개정은 부처명(기획재정부령→재정경제부령)만 바꿨고 요건은 그대로였다(구본 대조).
     */
    id: "TRANSFER_DECREE.LONG_TERM_MORTGAGE_HOUSE",
    citation: "소득세법 시행령 §155의2",
    keywords: [
  ...
  {
    /**
     * §155의3 — 상생임대주택. P3에서 인용 신설.
     * 🔑 면제 대상이 **세 조문**이라는 문언(「제154조제1항, 제155조제20항제1호 및 제159조의4」)을
     *    키워드로 동결한다 — 하나라도 빠지면 그만큼 과대 과세가 되는데, 조 단위 검증으로는
     *    그 변화가 잡히지 않기 때문이다.
     */
    id: "TRANSFER_DECREE.WIN_WIN_RENTAL_HOUSE",
    citation: "소득세법 시행령 §155의3",
    keywords: [
  ...
  },
  {
    ...
    keywords: [
      ...
      // ⑧3호 동일세대 상속 통산 — 판정 메뉴 입력 경로(OH-18)가 이 문언에 기댄다(MST 286211 실독 2026-09-26)
  ...
  },
  {
    ...
    keywords: [
      ...
      "직전거주주택보유주택",
      // ④⑤ 합가 의제의 「2주택」·⑩3호 귀농 면적 — pending 기한 외 요건(OH-23)이 이 문언에 기댄다
      "합침으로써 1세대가 2주택을 보유하게 되는 경우",
      "대지면적이 660제곱미터이내일 것",
      // §155⑳~㉓ 장기임대주택 거주주택 특례 — 엔진이 문언에 기대는 축(OH-15·16·39·41, 2026-09-26 MST 286211 실독)
      "같은 호 마목에 해당하는 주택의 경우에는 같은 목 1)에 따른 주택",
      "이후의 거주기간을 말한다",
      "양도일 현재 법 제168조에 따른 사업자등록을 하고",
      "임대의무기간의 2분의 1 이상을 임대한 경우에 한정한다",
    ],
    keywordMode: "ALL",
  },
  {
