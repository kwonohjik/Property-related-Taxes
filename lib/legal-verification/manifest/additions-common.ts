...
export const COMMON_ADDITIONS: VerificationRule[] = [
  ...
  {
    /**
     * ⑤ 키워드 추가(2026-09-12) — 간주취득(「지방세법」 §15②)의 농특세 과세표준 근거.
     * §5①6호는 §11·§12의 표준세율을 전제하는데 §15② 취득에는 그 표준세율이 없다.
     * 그 공백을 §5⑤이 메우므로, 이 항이 개정되면 간주취득 농특세가 통째로 달라진다.
     */
    ...
    keywords: [
      ...
      "100분의 14",
      "이자소득",
      "제15조제2항에 해당하는 경우에는 같은 항에 따라 계산한 취득세액",
    ],
    keywordMode: "ALL",
  },
  {
  ...
  },
  {
     ...
     * + 🔴 G-05 LATE_FILING_REDUCTION_48_2_3_RA(②3호**라목** 예정신고 무신고 → 확정신고기한
     *   이내 기한후신고 **일률 50%**).
     *
     * ⚠️ **세 감면 표가 같은 조문에 있으나 계단이 다르다** — ②1호는 90~10%(수정신고,
     *    §47의3 대상), ②2호는 50/30/20%(기한후신고, §47의2 대상), ②3호라목은 **일률 50%**
     *    (「제2호에도 불구하고」 — 2호를 배제한다). 혼용 금지.
     */
    ...
    keywords: [
      ...
      // 🔴 G-05 — ②3호라목. 이 문장이 사라지면 「라목 우선」 모델이 근거를 잃는다.
      "제2호에도 불구하고 세법에 따른 예정신고기한 및 중간신고기한까지 예정신고 및 중간신고를 하지 아니하였으나 확정신고기한까지 제45조의3에 따른 기한 후 신고를 한 경우",
    ],
    keywordMode: "ALL",
  },
  {
