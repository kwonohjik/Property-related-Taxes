...
const TH = "border border-neutral-400 px-1.5 py-1 text-center font-semibold text-[11px]";
const TD = "border border-neutral-400 px-1.5 py-1 text-center text-[11px]";
