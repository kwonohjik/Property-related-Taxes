...
// 800줄 분리 — 보조 위젯·카드 5개는 `GeneralBuildingAcquisitionCardsParts.tsx` 로 이동.
// ⚠️ `Props`는 **주 컴포넌트의 것**이라 함께 옮기지 않는다 — 블록에 딸려 갔던 것을 되돌렸다
//    ([[feedback_800line_split_playbook]] 「값·타입 선언이 블록에 딸려 간다」).
interface Props {
  asset: AssetForm;
