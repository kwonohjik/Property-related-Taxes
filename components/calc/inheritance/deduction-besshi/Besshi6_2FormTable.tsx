  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between mb-1">
        ...
        <p className="text-micro text-gray-500">(앞쪽)</p>
      </div>
      ...
      {/* 1. 신고자 */}
      <p className="mb-1 mt-2 text-caption font-bold">1. 신고자</p>
      <Besshi6_2Section1 data={data} />

      {/* 2. 동거주택 현황 */}
      <p className="mb-1 mt-3 text-caption font-bold">2. 동거주택 현황</p>
      <Besshi6_2Section2 data={data} />

      {/* 3. 동거주택 상속공제 */}
      <p className="mb-1 mt-3 text-caption font-bold">3. 동거주택 상속공제</p>
      <Besshi6_2Section3 data={data} />

      {/* 제출 문구 */}
      <div className="mt-3 text-micro text-gray-700 space-y-1">
        <p>
      ...
      <p className="mt-3 text-micro text-gray-500">{HANDWRITE_NOTE}</p>
      <p className="mt-1 text-micro text-gray-400">{PAPER_FOOTER}</p>
    </div>
  );
}
