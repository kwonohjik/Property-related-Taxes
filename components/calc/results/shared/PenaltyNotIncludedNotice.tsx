 ...
 *
 * ## 🔴 B1 → B2 로 범위가 두 번 좁아졌다
 *
 * · **B1** — 상속·증여 양쪽이 §47의2·§47의3 **일반율**을 산출하게 됐다.
 * · **B2** — **부정행위 40%·역외거래 60%**(§47의2①1호·§47의3①1호 가목·나목)도 산출한다.
 *
 * ⇒ 남은 축은 **납부지연가산세(§47의4)** 하나다.
 * ⚠️ **B3 가 그 축을 구현하면 이 배너는 지워야 한다** — 남겨두면 반대 방향의 거짓이 된다.
 *
 * ## 조문
 *
  ...
  return (
    <div className="rounded-lg border border-amber-300 bg-amber-50 dark:border-amber-800 dark:bg-amber-950/30 px-4 py-3 text-xs text-amber-800 dark:text-amber-300">
      ...
      <p className="leading-relaxed">
        이 {taxLabel} 금액에는 신고불성실가산세(국세기본법 §47의2·§47의3)가 반영돼 있습니다.{" "}
        <strong>납부지연가산세</strong>(§47의4)는 아직 계산하지 않습니다. 납부기한을 넘겼다면 실제
        고지세액은 이 금액보다 큽니다.
      </p>
    </div>
  );
