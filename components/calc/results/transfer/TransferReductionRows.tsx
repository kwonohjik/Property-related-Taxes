 ...
 * §77 감면율 세트 배지 라벨.
 *
 * 🔴 `current_2018`을 「**현행** 감면율」이라 부르지 않는다 (2026-09-07 UI 리뷰).
 *    엔진은 그 세트를 **2018-01-01 ~ 2024-12-31 양도분에만** 적용하고, 2025-01-01 이후
 *    양도분은 `AMENDED_2025`로 갈린다(`public-expropriation-reduction.ts:20~23`·`:214~225`).
 *    2020~2024년 사례를 계산한 사용자가 「현행」이라는 말을 보고 그 요율이 지금도 유효한
 *    현행법이라 오인했다 — 실제 현행은 2025 개정율이다. **적용 기간을 그대로 적는다.**
 */
const RATE_SET_LABEL: Record<string, string> = {
  amended_2025: "2025 개정율 (2025.1.1. 이후 양도 · 현금 15% / 채권 20~45%)",
  current_2018: "2018 감면율 (2018.1.1.~2024.12.31. 양도 · 현금 10% / 채권 15~40%)",
