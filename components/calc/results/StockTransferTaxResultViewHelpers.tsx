...
> = {
  ...
  "국외전출세§118의9": "소득세법 §118의9",
  "§94②우선": "소득세법 §94②",
  // §94①4 다목 요건 게이트 (2026-09-13) — 요건은 법 본문 + 영 §158①②
  "다목요건충족": "소득세법 시행령 §158",
  "다목요건미충족폴백": "소득세법 시행령 §158",
  "§168②대주주기납부차감": "소득세법 시행령 §168②",
  // 영 §158② 기신고분 합산 — 요건 조문은 §158②, 합산 계산의 전제는 §168②이다.
  //   배지는 «요건» 조문을 가리킨다(차감 배지가 §168②을 이미 가리킨다).
  "§158②기신고합산": "소득세법 시행령 §158②",
 ...
 *    ① 증권거래세 커버 시작일이 `2021-01-01` 로 적혀 있었으나 매트릭스는 그보다 이른 날부터
 *       연다(`STX_CUTOFF_DATE`). 당시 세율로 정확히 계산되고 경고도 뜨지 않는 구간을
 *       「미지원」이라 말하고 있었다. (커버는 이후 2026-09-14 에 2017-04-01 까지 더 넓어졌다 —
 *       문구가 상수 보간이라 **그때는 아무것도 고칠 게 없었다**. 그게 이 수정의 목적이다.)
