...
export function SaveButton({
  ...
  const primaryClass =
    "rounded-md border border-primary/30 bg-primary/10 text-primary px-5 py-2 text-sm font-medium hover:bg-primary/20 transition-colors disabled:opacity-50 disabled:cursor-not-allowed inline-flex items-center justify-center gap-1.5";
