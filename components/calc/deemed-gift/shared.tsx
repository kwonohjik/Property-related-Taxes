...
export type { CdShareholderRow, EdShareholderRow, CapTableRow, ScShareholderRow } from "./deemed-form-state";
export { INITIAL_DEEMED };
export { makeCapTableRow, makeScShareholderRow } from "./deemed-form-state";
