    ...
    <div className="rounded-lg border border-border bg-muted/10 p-4 space-y-3">
      ...
      {selfFarming && selfFarming.type === "self_farming" && (
        <div className="rounded-lg border border-dashed border-primary/40 bg-primary/3 p-4 space-y-3">
          ...
          {/*
            E2-09 (2026-09-03) — 「소득세법 시행령」 §168의8② 후단이 **비사업용 토지 판정**의
            자경기간에도 같은 §66⑭를 준용한다. 그쪽은 §168의6이 「직전 5년 중 2년 초과」·
            「직전 3년 중 1년 초과」의 구간 연산이라 **연도**를 받고, 여기는 자경기간이 스칼라라
            **연수**를 받는다. 같은 사실을 두 단위로 묻는 셈이므로 서로를 지목해 둔다.
          */}
          <p className="text-micro text-muted-foreground">
            비사업용 토지 정밀판정(3단계 「농지 세부 정보」)에도 같은 조문의 <b>결격 과세기간</b> 칸이
            있습니다 — 그쪽은 <b>연도</b>(예: 2019, 2020), 여기는 <b>연수</b>입니다. 둘 다 해당하면
            양쪽에 입력하세요.
          </p>
