...
**감정가액 안분 금지**: 청구인들이 반복 주장한 "양도 당시 감정평가액 기준 안분"은 3건 모두 배척됐다. 안분 기준에 감정가액·양도 당시 가액을 쓰는 UI를 만들면 안 된다.

---

## 9. 미검증 항목 (rev.2 → rev.6 갱신)
...
| ~~U-10~~ | 「소득세법 시행령」 제176조의2 제2항의 일부양도 해석 | ✅ **해소** — 조심 2018부0572(분할 양도 직접 사례). **안분 기준은 취득 당시 기준시가 비율**(면적비 아님)·**구분 가액 우선**·감정가액 안분 배척. §8.7 권고 정정(§8.8) |
| **U-11** | 취득 필요경비의 안분 기준 | 🔴 미검증 — 「소득세법」 제100조 제2항 후문 "가액에 비례하여 안분" 유추 가능하나 확인 전 (§8.8.4) |
