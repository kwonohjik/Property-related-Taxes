...
| ~~유예 창 나·다목(토지거래허가 조건부 배제 2026-09-09/11-09)~~ ✅ **종결** | 실측 결과 **이미 전건 구현** — `transfer-surcharge-grace-na-da-closure.md` |
...
- ~~**유예 창 나·다목**(토지거래허가 조건부 배제) — 별건.~~ ✅ **종결** — 이미 전건 구현(2026-08-25 실측).
