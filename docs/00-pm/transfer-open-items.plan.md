...
| R7 | #591 양도세 감사 백로그 | 미상 | 대 | 항목별 재검증 | **진행 중 — 99 → 77건** |
...
| `audit-fix-new-99-3` | 6/6 | §99의3 — 입력 필드명 상이(`transferPrice`/`transferIncome`) |
| `audit-fix-aggregate` | 5/7 | 다건 집계 |
...
7. **R7 진행 중** — 99 → 77. 다음: §99의3(6) · 다건 집계(5) · 주식 lot 배분(21).
