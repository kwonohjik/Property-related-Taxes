...
> **상태**: ✅ **구현 완료** (PR#423 · 2026-06-29) — 2026-08-04 코드 실측 · 2026-08-05 인용 PR·커밋 재검증(종전 헤더는 stale이었음).
> ~~종전 표기: Plan (13단계 자가검토 완료 · Do 대기) · 작성 2026-06-29 · 대상 `components/calc/transfer/CompanionAssetCard.tsx`~~
