...
| **F2** | 별표3~6·별표1의3 정본 자동산출 | 시행규칙 §83의4①③④⑨⑩⑫ · 별표3~6 · 시행령 별표1의3 | L | 중 | 기준면적 정확도 (면적안분 입력) | `gap-f2-annex-area-tables.plan.md` (Phase A ✅PR#249) · `gap-f2b-annex-phase-b.plan.md` (Phase B) |
