...
> ⛔ **본 §3#2(구 단순 차감 설계)는 폐기 — `docs/00-pm/multi-house-surcharge-2a-marriage.plan.md`로 대체**(2026-06-16, 13단계 재검토). 사유: ①§155⑤ 현행 **10년**(여기 5년 가정 오류) ②§167의10②가 ⑨ 미준용 → 2주택(§155⑤ 전면배제 10년)·3주택(§167의3⑨ 차감 5년) **메커니즘 분기** 필요(단순 차감 주입 불가). 아래 내용은 이력 보존용.
