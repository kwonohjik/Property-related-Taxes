...
- **🟠 미결 유지(2026-08-27 고시·계산사례 실측 — 「어느 쪽이 옳은지」가 갈렸다)**
  - **고시 문언은 「항상 적용」을 지지한다.** 제2025-39호 제11조 조정률표 **구분 II** 적용대상은 「최고층수 / 연면적 / 인텔리전트시스템빌딩」이고 적용범위 단서는 「최고층수 계산시 지하층·옥탑 제외 / 통나무조 적용 제외 / **주거용건물은 아파트에 한해 최고층수기준만 적용**」뿐 — **용도 제한이 없다**. 연면적은 어떤 구간엔 반드시 들어가므로 비주거면 항상 해당한다.
  - **계산사례도 그 방향이다.** 2026년 계산사례 마.의 지상1 근린생활시설은 조정률 칸에 **(9)0.9·(20)1.2** 가 기입되고 지상2·3 단독주택은 **빈칸**이다. 지하 부속도 슈퍼 귀속분만 9번이 붙어 0.54(=0.9×0.6), 주택 귀속분은 0.60이다 ⇒ 갈림은 **주거/비주거**이지 「특성을 골랐는가」가 아니다.
  - **그런데 저장소의 공식 사례 13건 중 4건이 반증한다.** 직업훈련소№33·노인주거복지№35·자원순환№54·판매시설№11 은 조정률 미적용으로 고정돼 있고, 같은 비주거·비슷한 연면적인 근생(라멘)№41·운동시설№24 는 `features: {}` 로 9번을 받아 공식 값과 맞는다. 갈림이 **`features` 필드 기재 유무**다. **게이트를 실제로 풀어 실측했더니 그 4건이 깨진다.**
  - 같은 파일의 필드 주석이 「manualAdj?: number; // **양도 사례(조정률 미적용)는 생략**」이라 적어, 4건이 **양도세 사례**일 가능성이 높다(그렇다면 고시대로 고쳐도 무방하다). 그러나 **이번에 받은 계산사례 PDF는 「마.」 항목만 담고 있어**(pp.71~77) 13건의 세목을 원본으로 확인할 수 없다.
  - ⇒ **착수 조건: 2026년 계산사례집 단일 건물 13건 원문(가~라 항목).** 세액을 바꾸는 변경이라 미확인 근거로 진행하지 않는다.
  - ✅ 그동안 **`{}` ↔ undefined 의 11.2% 괴리를 characterization anchor 로 고정**했다(`gazette-adjustment-auto-apply.anchor.test.ts` 9건). 기존 공식 사례 anchor 는 조정률을 manual 로 주입해 이 축을 한 번도 보지 않았다.
...
**F-06 · F-09 · F-26 · F-29 · F-37 · F-38 · F-41** — 이 7건은 고시 원문 확보가 착수 조건이다. 확보 없이 어느 방향으로 고쳐도 국세청 공식 계산사례 anchor가 깨진다.
