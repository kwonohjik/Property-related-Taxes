...
**남은 별건 3건**(이 리뷰의 findings 가 아니라 그 과정에서 분기된 것):
- **F-07 잔여** — 시군구 별칭 표 확충(전남·광주 24 + 전주 2 뿐, 강원 42→51·전북 나머지 없음). 배선은 끝났다.
- **F-41 잔여** — 없음(고시 제2025-39호로 양자화 제거 완료).
- ~~**연도 순서 검증**~~ → **2026-09-12 종결**(아래).
