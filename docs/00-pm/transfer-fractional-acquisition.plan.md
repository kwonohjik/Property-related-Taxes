...
> **anchor 사례**: 예제 사례 27 — "아파트를 2번에 걸쳐 지분취득한 경우"
...
### 7.2 anchor 항목 (사례 27 예제 PDF 100% 일치 목표)
...
**핵심 검증**: 예제 사례 27 PDF 산출세액 **39,702,352** / 지방세 **3,970,235** / 총 납부세액 **43,672,587** 모두 **원단위 일치** ✅
