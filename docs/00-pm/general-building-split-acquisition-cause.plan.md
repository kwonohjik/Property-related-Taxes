...
> 사례 32 작업 후속 UX 개선. 예제 UI 패턴(토지/건물 분리 입력)에 정렬.
> 작성일: 2026-05-10
...
**참고**: 예제 UI(`사례 32 Image 2`)는 구분 단계에서 토지·건물 각각 취득일자·취득원인을 별도로 입력. 본 작업은 그 패턴에 정렬.
...
- **예제 호환성**: 본 변경 후 예제 UI(Image 2 사례 32 입력 화면)와 1:1 매핑. 책 사례 따라 입력하기 직관적.
