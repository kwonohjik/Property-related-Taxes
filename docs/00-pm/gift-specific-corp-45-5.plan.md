...
- **①** 지배주주와 그 친족("지배주주등")이 직·간접 보유 **주식보유비율 30% 이상 법인**("특정법인")이 **지배주주 및 그 특수관계인**과 각 호 거래 시, **특정법인의 이익 × 지배주주등 주식보유비율**을 지배주주등이 증여받은 것으로 본다.
  - 🔴 **문언 정정**: 종전 기재 「지배주주**의** 특수관계인」은 **개정 전 문언**이다. 현행(법률 제21219호, 시행 2026.1.1 · MST 280353) verbatim은 「… 특정법인이 **지배주주 및 그 특수관계인**과 다음 각 호에 따른 거래를 하는 경우」로, 거래상대방에 **지배주주 본인이 포함**된다.
  - ⚠️ 반면 **영 §34의5②**(3의2호 자본거래)는 지금도 「특정법인과 **지배주주의 특수관계인** 사이에」로 좁다 — 같은 문구가 두 축에 있으므로 **전역 치환 금지**다(실측: 저장소의 「지배주주의 특수관계인」 19곳 중 대부분이 영 §34의5② 인용이라 정확하다).
...
| 유형 | 근거 | 기준 |
|---|---|---|
| 본인증여분 제외 | 상증법 §2 6호 "**타인에게**" + 영 §34의5⑨(자기증여는 직접증여 가정 증여세가 0이라 한도도 0) | 증여자 본인이 주주이면 자기 지분분은 수증 아님 → 제외 |
