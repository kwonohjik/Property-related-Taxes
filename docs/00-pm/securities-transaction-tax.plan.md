...
> ⚠️ **Phase 2 정정 고지 (2026-06-11)**: 본 문서의 "2026.01.02 시행"(영 35947호 귀속) 표기는 **오류** — §5 세율 개정은 **영 제36001호(2025.12.31 공포, 2026.1.1 시행)** 이고 35947호는 부처명 타법개정으로 §5 무관. 이에 따라 Phase 1의 경고 경계(2026-01-02)는 1일 오류였으며, STX-09 anchor는 Phase 2에서 법령 정합값(2025 영세율 구간)으로 재산정됨. 연도별 세율·정정 상세: [`securities-transaction-tax-phase2.plan.md`](securities-transaction-tax-phase2.plan.md) §1-2·§2-3. 아래 본문은 당시 기록으로 보존하며 충돌 시 Phase 2 문서가 우선.
