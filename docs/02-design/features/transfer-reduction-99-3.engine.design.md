...
**1번 우선순위 사례**: 사용자 제공 PDF (예제 프로그램 재현 사례 26) — 갑氏 서울 서초구 A아파트 2023.02.16 양도. PHD 환산 + §99의3 5년 안분 결합.
...
|---|---------|----------|-------------|-----------|------|
| 1 | 5년 후 양도 + PHD(공동주택 최초고시 전 취득) + 분자/분모 양수 | §99의3 ① 본문 + §164⑤ | 예제 사례 26 (`reduction-99-3-case-2023.md`) | `reduction-99-3.test.ts` | ☐ TODO |
