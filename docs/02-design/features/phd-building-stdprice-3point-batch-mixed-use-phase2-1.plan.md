...
- **서일46014-10014(2002.1.7)**: 취득당시 적용 기준시가는 **취득일 현재 공시된 값**(용도·지목 사후 변경 무관) — 현황평가 원칙.
...
> 미확보(추정 배제): 위 예규들의 회신 **본문**은 NTS 세션 필요로 미조회(제목·존재·일자만 확정). 재일46014-2396 본문은 확보(사용자 제공). 다수 자료가 후보 H로 수렴하고 후보 C는 §164⑦ 메커니즘과 배치 → 확신도 상.
