...
### 2.4 부정행위 해당 여부 판단 기준 (국세기본법 §26의2②2호 · 같은 법 시행령 §12의2① · 조세범 처벌법 §3⑥)
...
export const PENALTY = {
  ...
  /** 부정행위의 정의 — 국세기본법 §26의2②2호 · 같은 법 시행령 §12의2① · 조세범 처벌법 §3⑥ */
...
| 국세기본법 · 같은 법 시행령 · 조세범 처벌법 | §26의2②2호 → 시행령 §12의2① → 조세범 처벌법 §3⑥ | 부정행위 정의 (위임 체인) |
