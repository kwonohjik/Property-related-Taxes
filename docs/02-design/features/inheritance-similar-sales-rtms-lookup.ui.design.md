...
- 상증법 시행규칙 §15③1호: 공동주택 유사재산 3요건 — ①동일 공동주택단지 ②전용면적 차이 **±5%** 이내 ③공동주택가격(기준시가) 차이 **±5%** 이내 (KoreanLaw MST 284609 검증). **⚠️ 정정: 초안의 "§15① 공시가격 ±20% (§15의3 준용)"은 오기 — 법적 근거 없음. 공동주택가격 임계는 §15③1호다목 ±5%다. Plan §9 D7 BINDING.**
- 상증법 시행규칙 §15③1호단서: 유사재산이 둘 이상이면 공동주택가격 차이가 가장 작은 주택
