...
1. **승계 입주권의 환산·감정·매매사례 취득가액 미지원** — 입주권의 §99①2호 기준시가(영 §165) 산정 경로가 없다. validate로 명시 차단하고 후속 **R-12**로 남긴다.
2. **원조합원 입주권에 감정·매매사례 미지원** — §166①은 「기존건물과 그 부수토지의 취득가액」을 요구하고, 확인 불가 시의 대체는 §166③ 환산으로 **법이 이미 정해 두었다**. §176의2③ 추계를 끼워 넣을 근거를 확인하지 못했다 → 후속 **R-9**.
...
| **V-6** | ⚠️ **승계 후 청산금 수령 케이스는 미지원**으로 확정. 기준-2025-법규재산-0057은 납부 사례만 다루고 수령 사례의 취득가액 차감 근거를 확보하지 못했다. 입력칸을 만들지 않고 hint에 명시("청산금을 수령한 경우는 현재 지원하지 않습니다") — 음수 입력은 ⑧ validate가 차단한다. 근거 확보 시 **R-13**으로 착수 |
...
| ID | 내용 |
|---|---|
| **R-9** | 원조합원 입주권의 감정가액·매매사례가액 — §166③ 환산이 법정 대체수단이라 §176의2③ 추계를 끼울 근거 미확보 |
| **R-10** | 증여·상속·신축 취득원인 블록의 중복 입력 (완공APT와 공통) |
| **R-12** | 승계 입주권의 환산·감정·매매사례 — 입주권 §99①2호 기준시가(영 §165) 산정 경로 부재 |
| **R-13** | 승계 후 청산금 **수령** 케이스 (V-6) |
