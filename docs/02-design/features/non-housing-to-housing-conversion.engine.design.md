...
| **「소득세법」 §95④** | "**제2항에서 규정하는** 자산의 **보유기간**은 그 자산의 **취득일부터 양도일까지**로 한다" — 표2는 제2항의 표이므로 표2 안의 "보유기간"에 직접 걸린다 | ✅ 본문 확인 (2026-08-05) |
| **「소득세법」 §95⑥** | "제5항제1호 및 제2호에 따른 **「주택으로 보유한 기간」**은 …사실상 주거용으로 사용한 날부터 기산" — 재정의 대상은 별개 개념어이고 "보유기간"이 아니다 | ✅ 본문 확인 (2026-08-05) |
| **「소득세법」 §95② 본문 · ⑤ 첫머리** | ②본문이 장특 대상을 "**보유기간이 3년 이상인 것**"으로 정하고, ⑤은 "제2항 **단서**에도 불구하고"라 하여 **본문의 3년 요건은 배제하지 않는다** | ✅ 본문 확인 (2026-08-05) |
| §95⑤ 하 표2 거주 "(보유기간 3년 이상 한정)"의 지시 대상 | **총 보유기간**(A안) — 위 §95④·⑥·②본문 3개 조항의 문리·체계 해석. 반대해석(주택 보유기간)은 ⑤1호가 표2 보유기간 열에 주택 기간을 대입하는 점을 근거로 하나 명문 없이 8%p 불리 | ✅ **확정 (V-4)** — 예규·심판례는 0건이므로 실무 해석 등장 시 재확인 |
...
| 거주공제율 "보유 3년 이상" 기준기간 | ✅ **총 보유기간 기준** (V-4 확정 2026-08-05) | §95④(표2 보유기간 정의) + §95⑥(재정의 대상은 「주택으로 보유한 기간」뿐) + §95⑤이 배제한 것은 ②**단서**뿐 — §3.1. 반대해석은 명문 없이 8%p 불리 (memory `feedback_no_unfavorable_application_without_legal_basis`) |
