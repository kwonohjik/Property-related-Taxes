...
예제 사례 33: 갑씨가 서울 동작구 사당동 132-10 일반건물(상가)을 2003-03-17 취득가액 200,000,000원(토지+건물 일괄), 필요경비 8,000,000원으로 취득. 2007-07-24 건물 증축(실가 입증 불가). 2023-02-19 330,000,000원으로 양도. 증축분(건물2) 취득가액을 환산취득가로 계산 → 산출세액 **6,480,952** / 지방세 **648,095**.
...
| 활성화 조건 | `gbHasExtension === true` |
| 정렬 | 자가증축 먼저 (예제 정렬 준용 — 자가신축이 사례 33 primary) |
...
포함 섹션: §9 결과 카드 3-way 분기 / §10 Validation 규칙 / §11 Zod 스키마 / §12 Route Handler / §13 사이드바 / §14 예제 매핑 / §15 정책 매트릭스 / §16 800줄 실측 목록 / §17 수동 테스트 / §18 DoD 체크리스트 / §19 비스코프 / §20 Status / 부록(무효 판정 2건)
