...
산출세액 (양도연도 2023 §55 누진세율표 — 외부 자료 추종 금지)
  ★ 2023년 적용 소법 §55 세율표로 직접 계산 (예제 PDF 산출값 anchor 금지)
...
- [ ] 예제 PDF 분모/분자 1:1 재현 검증: 합계 기준시가 = 920,550,000 + 20,629,440 = **941,179,440** (잘못된 anchor 940,173,824 박제 방지)
