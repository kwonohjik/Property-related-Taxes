...
## 8. Phase 2 완결 + Phase 3b 입력폼 직접 링크 (2026-06-17, 법제처 네트워크 복구)

**Phase 2 전건 검증 완료**: 본법(캐시) + 시행령(법제처 API MST 283639) 대조 → §4 드리프트 해소(§4.절) + legal-codes 4건 정정 완료.

**Phase 3b 입력폼 직접 링크** (`<p>` 도움말·안내 — LawArticleModal import 3파일):
- ✅ Step1Basic: §9①2호(→§9)·§10 (세율·세부담상한 도움말).
- ✅ page.tsx: P3 §10 단서(법인 안내)·P7 §10(상한 산식).
