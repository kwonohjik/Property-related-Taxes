...
// ============================================================
// MH-11: 조특법 감면 미분양·신축주택 → 주택 수 **산입** (F-11 · 2026-09-19 정정)
// ============================================================
// 종전 기대값(2)은 결함을 고정하고 있었다. 조특법 §98의2·98의3·98의5~8·99·99의2·99의3은
// 「소득세법 제89조제1항제3호(비과세)를 적용할 때」만 소유주택으로 보지 않는다 — 중과 주택 수 불산입은
// 영 §167의3① 괄호(제1호·제12호)뿐이다. 감면 주택은 ①5호로 **중과 대상에서만** 빠진다.

describe("MH-11: 조특법 감면 미분양·신축주택은 주택 수에 산입", () => {
  it("감면주택 1채 포함 3주택 → effectiveHouseCount=3 (불산입 사유 없음)", () => {
...
// ============================================================
// MH-12: 주거용 오피스텔 — 취득일과 무관하게 산입 (F-11 · 2026-09-19 정정)
// ============================================================
// 종전 「2022.1.1 전 취득분 불산입(경과규정)」은 양도세에 근거가 없었다. 사실상 주거용이면 주택이다
// (심사-양도-2020-0038 · 조심-2023-서-10142 — 모두 3주택 판정에 산입).

describe("MH-12: 주거용 오피스텔은 취득일과 무관하게 산입", () => {
  it("2021.12.31 취득 오피스텔 → 산입", () => {
    const h1 = makeHouse("h1");
    const h2 = makeHouse("h2", {
      isOfficetel: true,
      isApartment: false,
