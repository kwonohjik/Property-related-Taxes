 ...
 *
 * ## 범위 밖으로 남긴 것 — 근거 미확보
 * 두 목의 단서 「**2018년 3월 31일까지** 사업자등록등을 한 주택으로 한정한다」는 구현하지 않았다.
 * 그 단서의 **신설 시기**를 확인하지 못했다 — 현행 소령을 과거 양도분에 소급하면
 * 법 근거 없는 불리 적용이 된다(행위시법). 부칙 확인 후 별건으로 붙인다.
 * 같은 이유로 CB-01(2014-01-01 하한 제거)도 법률 제12173호 부칙 확인 전까지 보류다.
 */
