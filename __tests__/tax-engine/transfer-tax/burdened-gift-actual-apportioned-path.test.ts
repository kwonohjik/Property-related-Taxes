...
describe("부담부증여 K-4 — 실지취득가액 안분 (소령 §159①1호 본문)", () => {
  ...
  it("개산공제 미적용 — 실비(자본적지출+양도비) 채무비율 안분", () => {
    // 실비 12,000,000 × 155,000,000 / 450,000,000 = 4,133,333 (채무 안분)
    // 토지: 4,133,333 × 147,000,000 / 210,000,000 = 2,893,333
    // 건물: 4,133,333 − 2,893,333 = 1,240,000 (잔액 흡수)
    expect(breakdown.perAsset.land.estimatedDeduction).toBe(2_893_333);
    expect(breakdown.perAsset.building.estimatedDeduction).toBe(1_240_000);
  });
