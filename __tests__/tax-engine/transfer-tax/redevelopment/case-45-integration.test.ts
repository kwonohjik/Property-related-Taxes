 ...
 * → STEP 3 (12억 안분) 활성 → 분기별 LTHD 거주귀속 분리 (§154⑧1호 + 사전법령해석재산 2020-386)
 *
 * ★ Primary anchor (예제 xlsx C26·C29·C31 원단위 정합 — PDF p6 표기와 1원 차이는 PDF 단수 오차):
 ...
 *
 * 거주월수 귀속 (사전법령해석재산 2020-386 + 시행령 §154⑧1호):
