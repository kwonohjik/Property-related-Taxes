...
// ──────────────────────────────────────────────────────────────
// T-A23-5: 전체 양도차익 (예제 anchor)
// ──────────────────────────────────────────────────────────────

describe("T-A23-5: 전체 양도차익 = 1,066,517,093 (예제 anchor)", () => {
...
// ──────────────────────────────────────────────────────────────
// T-A23-6: 12억 초과 과세 양도차익 (예제 anchor)
// ──────────────────────────────────────────────────────────────

describe("T-A23-6: 12억 초과 과세 양도차익 = 96,956,099 (예제 anchor)", () => {
...
describe("T-A23-7: LTHL 표1 30% = 29,086,829 (예제 anchor)", () => {
...
// ──────────────────────────────────────────────────────────────
// T-A23-8: 양도소득금액·과세표준 (예제 anchor)
// ──────────────────────────────────────────────────────────────

describe("T-A23-8: 양도소득금액 = 67,869,270 / 과세표준 = 65,369,270 (예제 anchor)", () => {
...
// ──────────────────────────────────────────────────────────────
// T-A23-9: 산출세액 24% 구간 (예제 anchor)
// ──────────────────────────────────────────────────────────────

describe("T-A23-9: 산출세액 = 9,928,624 (예제 anchor)", () => {
