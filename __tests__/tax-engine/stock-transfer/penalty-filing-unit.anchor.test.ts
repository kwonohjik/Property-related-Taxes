 ...
 * · **국외주식도 같은 신고 단위** — 근거는 §118의8이 아니라 **§110①(확정신고) 직접 적용**이다
 *   (§118의2의 「국외자산」에서 3호·4호가 삭제돼 국외주식은 §118의8 대상이 아니다).
 *   종전에는 국외 종목의 가산세가 **0으로 고정**돼 혼합 신고에서 통째로 빠졌다.
...
// ============================================================
// PU-1 — 국외 종목이 가산세 base 에 들어간다 (소득세법 §110① · 국세기본법 §47의2~4)
// ============================================================
