...
// TODO(커밋 1 — G-1·G-2 수정): describe.skip → describe 로 전환 (Pre-Do red 커밋 금지 정책)
// Pre-Do 실측 (2026-06-12, 현행 엔진): ⓐ/ⓒ 2,970,000 · ⓑ/ⓓ 576,000 · 세액공제 604,800
//   · 결정 259,200 · 농특세 51,840 — 설계 §3 예측과 전 항목 일치 (G-1 영향 실증 완료)
describe.skip("사례12 Pre-Do anchor — 재산세 안분 FMR 45% (C12-A1·A2)", () => {
