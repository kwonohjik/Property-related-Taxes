...
describe("NTS 공식 계산사례 2023 — 복합건물(섹션3)", () => {
  // 나.층별 구조 — 공시지가 560,000(50~65만) 위치지수 = 0.98 (2023 위치지수표 #13 원본 확인 완료, 2026-06-11).
  //   ⚠️ 계산사례 나는 0.97을 써서 합계 859,000,000(1층 349,000·2층 97,000)이나, 이는 PDF 계산사례 오류
  //   (위치지수표 #13=98과 불일치). 엔진값(0.98) 기준 합계 870,000,000이 정답.
  it("나.층별 구조 상이 — 엔진 0.98(위치지수표 확정) 합계 870,000,000 (계산사례 0.97은 PDF 오류)", () => {
