...
**✅ 호스팅 러너 실측 (run 32782638501 — PR #1276 첫 완주)**:

| job | 소요 | 내역 |
|---|---|---|
| typecheck + lint | 175초 | npm ci 27 · typecheck 38 · **lint 94** |
| test 4샤드 | 259~287초 | npm ci 23 · **vitest 253초** |
| E2E 6샤드 | 285~413초 | |
| 리포트 병합 | 45초 | |

**벽시계 976초(16.3분) → 461초(7.7분), −53%.** 임계 경로는 예정대로 E2E로 옮겨갔다(최장 샤드 413초 + 리포트 45초 = 458초).
